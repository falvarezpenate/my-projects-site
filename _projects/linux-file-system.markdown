...
description: >-
    Implemented a <strong>console application</strong> in <code>C</code> that simulates an <code>ext2 file system</code> within a given disk in <strong>Ubuntu</strong>. 
details: >-
